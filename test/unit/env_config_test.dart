...
void main() {
  test('SUPABASE_URL and SUPABASE_ANON_KEY are correctly loaded from .env', () {
    ...
    final String keyPreview = supabaseAnonKey.isNotEmpty
    ...
    expect(
      ...
      isNotEmpty,
      reason:
          'SUPABASE_URL nebol načítaný. Skontrolujte vlajku --dart-define-from-file',
    );
    expect(
      supabaseUrl.startsWith('https://'),
      isTrue,
      reason: 'SUPABASE_URL musí byť platná HTTPS adresa',
    );
    expect(
      supabaseAnonKey,
      isNotEmpty,
      reason: 'SUPABASE_ANON_KEY nebol načítaný.',
    );
  });
}
